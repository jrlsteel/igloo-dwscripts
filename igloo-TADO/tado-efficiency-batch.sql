...
create table ref_calculated_tado_efficiency_batch as
  select x1.user_id,
         ...
         (select avg_perc_diff
          from ref_calculated_tado_efficiency_average)                                                    as igloo_avg_perc_diff,
         (select avg_savings_in_pounds
          from ref_calculated_tado_efficiency_average)                                                    as igloo_avg_savings,
         (select stdev_perc_diff
          from ref_calculated_tado_efficiency_average)                                                    as igloo_stdev_avg_perc_diff,
         (select stdev_savings_in_pounds
          from ref_calculated_tado_efficiency_average)                                                    as igloostdev__avg_savings,
