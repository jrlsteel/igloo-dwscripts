...
from (select x1.*,
    ...
    --Model 2nd Level Inputs
      from (select x.user_id,
                   ...
                   x.gas_consumption_accuracy_type,
                   x.gas_consumption_accuracy_value
          -- Model 1st Level Inputs
            from (select u.id                                            as user_id,
                         ...
                         get_best_consumption(rcag.igl_ind_aq, rcag.ind_aq, rcag.pa_cons_gas, rcag.quotes_aq,
                                              'gas')                     as gas_consumption_accuracy_type,
                         case get_best_consumption(rcag.igl_ind_aq, rcag.ind_aq, rcag.pa_cons_gas, rcag.quotes_aq,
                                                   'gas')
                           when 'igl_ind_aq'
                  ...
                  from ref_cdb_supply_contracts su
                         ...
                         left outer join ref_consumption_accuracy_gas rcag on su.external_id = rcag.account_id
                  ...
                  group by u.id, su.external_id, su.supply_address_id, addr.postcode,
                           get_best_consumption(rcag.igl_ind_aq, rcag.ind_aq, rcag.pa_cons_gas, rcag.quotes_aq,
                                                'gas'),
                           case get_best_consumption(rcag.igl_ind_aq, rcag.ind_aq, rcag.pa_cons_gas, rcag.quotes_aq,
                                                     'gas')
