select su.external_id                                       as account_id,
    ...
    -- Meterpoint Attributes  Gas  Section
       ...
       max(case
             when mpa_gas.attributes_attributename = 'Current_Mam_Abbreviated_Name' then mpa_gas.attributes_attributevalue
       ...
       max(case
             when mpa_gas.attributes_attributename = 'Gas_Imperial_Meter_Indicator' then mpa_gas.attributes_attributevalue
       ...
       max(case
             when mpa_gas.attributes_attributename = 'Gas_Meter_Manufactured_Year' then mpa_gas.attributes_attributevalue
               end)                                         as meterpoint_attribute_gas_meter_manufacturer_year,
       max(case
             when mpa_gas.attributes_attributename = 'Gas_Meter_Manufacturer_Code' then mpa_gas.attributes_attributevalue
