...
create table if not exists public.ref_smart_inventory
(
...
alter table public.ref_smart_inventory owner to igloo
;
...
create table if not exists public.ref_smart_inventory_audit
(
	dspinventory_cad_cplstatus varchar(15),
	dspinventory_cad_cspregion varchar(15),
	dspinventory_cad_datecommissioned timestamp,
...
alter table public.ref_smart_inventory_audit owner to igloo
;