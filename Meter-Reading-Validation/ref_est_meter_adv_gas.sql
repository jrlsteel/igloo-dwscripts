...
select count(*) from ref_cdb_supply_contracts su
        inner join ref_meterpoints mp on mp.account_id = su.external_id and mp.meterpointtype = 'G' and
    (least(mp.supplyenddate, mp.associationenddate) is null or least(mp.supplyenddate, mp.associationenddate) >= current_date)
    inner join ref_meters m on m.account_id = su.external_id and m.meter_point_id = mp.meter_point_id and removeddate is null
--     inner join ref_registers r on r.account_id = su.external_id and r.meter_id = m.meter_id
;
...
alter table ref_stg_tolerances owner to igloo
;
...
delete from ref_stg_tolerances;

insert into ref_stg_tolerances values
       (1, 'consumption_accuracy', 'ind_eac_quoted_elec', null, null, null, -0.15, 0.15, '2017-01-01 00:00:00.000000', null),
       (1, 'consumption_accuracy', 'ind_aq_quoted_gas', null, null, null, -0.15, 0.15, '2017-01-01 00:00:00.000000', null),
       (1, 'consumption_accuracy', 'pa_cons_elec_quoted_elec', null, null, null, -0.15, 0.15, '2017-01-01 00:00:00.000000', null),
       (1, 'consumption_accuracy', 'pa_cons_elec_ind_eac', null, null, null, -0.15, 0.15, '2017-01-01 00:00:00.000000', null),
       (1, 'consumption_accuracy', 'pa_cons_gas_quoted_gas', null, null, null, -0.15, 0.15, '2017-01-01 00:00:00.000000', null),
       (1, 'consumption_accuracy', 'pa_cons_gas_ind_gas', null, null, null, -0.15, 0.15,'2017-01-01 00:00:00.000000', null),
       (1, 'consumption_accuracy', 'igl_ind_eac_pa_cons_elec', null, null, null, -0.15, 0.15,'2017-01-01 00:00:00.000000', null),
       (1, 'consumption_accuracy', 'igl_ind_aq_pa_cons_gas', null, null, null, -0.15, 0.15,'2017-01-01 00:00:00.000000', null),
       ...
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 1, 1, 'tolerance value in %', 0, 2000000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 2, 100, 'tolerance value in %', 0, 20000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 101, 200, 'tolerance value in %', 0, 10000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 201, 500, 'tolerance value in %', 0, 4000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 501, 1000, 'tolerance value in %', 0, 2000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 1001, 5000, 'tolerance value in %', 0, 400, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 5001, 10000, 'tolerance value in %', 0, 200, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 10001, 20000, 'tolerance value in %', 0, 150, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 20001, 73200, 'tolerance value in %', 0, 300, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 73201, 732000, 'tolerance value in %', 0, 250, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 732001, 2196000, 'tolerance value in %', 0,200, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_inner', 2196001, 29300000, 'tolerance value in %', 0, 700, '2017-01-01 00:00:00.000000', null),

       (3, 'industry_tolerance_gas', 'ind_gas_outer', 1, 1, 'tolerance value in %', 2000000, 7000000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 2, 100, 'tolerance value in %', 20000, 45000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 101, 200, 'tolerance value in %', 10000, 25000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 201, 500, 'tolerance value in %', 4000, 55000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 501, 1000, 'tolerance value in %', 2000, 25000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 1001, 5000, 'tolerance value in %', 400, 7000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 5001, 10000, 'tolerance value in %', 200, 2000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 10001, 20000, 'tolerance value in %', 150, 1100, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 20001, 73200, 'tolerance value in %', 300, 1100, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 73201, 732000, 'tolerance value in %', 250, 1000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 732001, 2196000, 'tolerance value in %', 200, 1000, '2017-01-01 00:00:00.000000', null),
       (3, 'industry_tolerance_gas', 'ind_gas_outer', 2196001, 29300000, 'tolerance value in %', 150, 700, '2017-01-01 00:00:00.000000', null);

insert into ref_stg_tolerances values
       (4, 'industry_tolerance_elec', 'ind_elec', null, null, 'tolerance value in %', 0, 200, '2017-01-01 00:00:00.000000', null);
