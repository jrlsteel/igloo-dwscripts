drop table ref_readings_internal_nosi;
create table ref_readings_internal_nosi
(
...
drop table ref_readings_internal_nosi_audit;
create table ref_readings_internal_nosi_audit
(
	account_id bigint encode delta32k distkey,
	meter_point_id bigint encode delta32k,
	meter_id bigint encode delta32k,
...
alter table ref_readings_internal_nosi_audit owner to igloo
;