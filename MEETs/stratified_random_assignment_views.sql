create or replace view meets_signup_groups as
select dcf_signup.*,
...
from meets_project_data mpd
         ...
         left join igloo_datawarehouse_uat.ref_calculated_daily_customer_file dcf
...
from igloo_datawarehouse_uat.ref_calculated_daily_customer_file;
