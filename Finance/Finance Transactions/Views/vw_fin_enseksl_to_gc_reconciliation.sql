create or replace view vw_fin_enseksl_to_gc_reconciliation as
...
select *
from cte_report_summary_SL02


    WITH NO SCHEMA BINDING
;

alter table vw_fin_enseksl_to_gc_reconciliation owner to igloo
;
