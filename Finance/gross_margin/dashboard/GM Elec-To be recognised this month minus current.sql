...
from (select c.gspgroupid,
         ...
         c.Billed_Revenue - d.Billed_Revenue                       as "Billed_Revenue",
         c.BilledStandingCharge - d.BilledStandingCharge           as "BilledStandingCharge",
         c.WholesaleCost - d.WholesaleCost                         as "WholesaleCost",
         c.rcrccost - d.rcrccost                                   as "rcrccost",
         c.bsuoscost - d.bsuoscost                                 as "bsuoscost",
         c.tnuoscost - d.tnuoscost                                 as "tnuoscost",
         c.duoscommoditycost - d.duoscommoditycost                 as "duoscommoditycost",
         c.duoscapacitycost - d.duoscapacitycost                   as "duoscapacitycost",
         c.aahedccost - d.aahedccost                               as "aahedccost",
         c.robuyoutcost - d.robuyoutcost                           as "robuyoutcost",
         c.cfdoperationalcost - d.cfdoperationalcost               as "cfdoperationalcost",
         c.cfdinterimcost - d.cfdinterimcost                       as "cfdinterimcost",
         c.cfdrecadj - d.cfdrecadj                                 as "cfdrecadj",
         0                                                         as key
...
--A - To date = latest file all months
        ...
        order by a.gspgroupid) c
         inner join (select gspgroupid_1                   as gspgroupid,
      ...
      order by gspgroupid_1) d on c.gspgroupid = d.gspgroupid
                  ...
                  order by a.gspgroupid) c
                   inner join (select gspgroupid_1                   as gspgroupid,
                               ...
                               where consumptionmonth = '$ReportMonth'
                                 and timestamp = '$ReportMonth'
                group by gspgroupid_1
                order by gspgroupid_1) d on c.gspgroupid = d.gspgroupid ) stg
           ) stg_Tots)tots
